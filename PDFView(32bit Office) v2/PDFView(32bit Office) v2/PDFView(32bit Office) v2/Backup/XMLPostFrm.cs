                ...
                try
                {
                    ...
                    if (!ft.IsGUID(Path.GetFileNameWithoutExtension(SessionInfo.UserInfo.CachePath)) || string.IsNullOrEmpty(IDvalue))
                    {
                        if (SessionInfo.UserInfo.OpentransuponSave)
                        {
                            ...
                            {
                                Globals.ThisAddIn.Application.ActiveWorkbook.SaveAs(AppDomain.CurrentDomain.BaseDirectory + tmp + Path.GetExtension(SessionInfo.UserInfo.FilePath));
                            ...
                            Globals.ThisAddIn.Application.ActiveWorkbook.SaveCopyAs(AppDomain.CurrentDomain.BaseDirectory + tmp + Path.GetExtension(SessionInfo.UserInfo.FilePath));
                        ...
                        //else
                        cmd.Parameters.Add(new SqlParameter("@Data", ft.GetData(AppDomain.CurrentDomain.BaseDirectory + tmp + Path.GetExtension(SessionInfo.UserInfo.FilePath))));
